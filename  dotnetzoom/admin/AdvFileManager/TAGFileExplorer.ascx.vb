            ...
            Else
                Try
                    ...
                    If RelativeDir = "" Then
                        ...
                        _UploadInfo.UploadDirectory = Root
                        If Not Right(_UploadInfo.UploadDirectory, 1) = "\" Then
                            _UploadInfo.UploadDirectory += "\"
                        End If
                    Else
                        CurrentDir = New DirectoryInfo(Root & RelativeDir)
                        _UploadInfo.UploadDirectory = Root & RelativeDir & "\"
                    End If
                    ...
                    _UploadInfo.IsHost = Not (Request.Params("hostpage") Is Nothing) And PortalSecurity.IsSuperUser()
                    _UploadInfo.Extension = PortalSettings.GetHostSettings("FileExtensions").ToString()
                    _UploadInfo.Name = Nothing
                    _UploadInfo.Comment = Nothing
                    _UploadInfo.Type = Nothing
                    _UploadInfo.Unzip = False
                    _UploadInfo.CUnzip = True
