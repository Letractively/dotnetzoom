...
<ItemTemplate>
<asp:HyperLink id="hypBanner" Runat="server" EnableViewState="false" NavigateUrl='<%# "~/DesktopModules/Banners/BannerClickThrough.aspx?BannerId=" & DataBinder.Eval(Container.DataItem,"BannerId") %>'>
