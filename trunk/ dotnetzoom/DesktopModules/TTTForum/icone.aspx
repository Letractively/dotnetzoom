...
If Not Request.Params("parentID") is nothing and Session("ForumThumbPath") <> ""  then
ParentId = Request.Params("parentID")
else
GalleryPlaceHolder.Visible = False
CanIUpload.Visible = False
ResultsMessage.Text = GetLanguage("NoFolderFoundMessage") 
return
end if
   ...
   ImagesFolder = Session("ForumThumbPath")
   ImageUrl =  Session("ForumThumbPath") 
        ImagesFolder = Server.MapPath(ImagesFolder)
           ...
           Try 
			...
			System.IO.File.Delete(ImagesFolder + "temp" + Ext)
                            ...
                            Catch ex As Exception
                                LogMessage(HttpContext.Current.Request, "Erreur icone.aspx delete, " + ImagesFolder + " " + ex.Message)
...
' AppPath = HttpContext.Current.Request.PhysicalApplicationPath 
 ...
 If Not (ImagesFolder = "") Then 
   ...
   FilesArray  = System.IO.Directory.GetFiles(ImagesFolder, "*") 
            Catch e As Exception
                LogMessage(HttpContext.Current.Request, "Erreur icone.aspx DisplayImages, " + ImagesFolder + " " + e.Message)
            End Try
 End If 
 ...
 Else 
   ...
   GalleryPlaceHolder.Controls.Add(New LiteralControl("<td width=""110"" align=""center""  style=""height: 110px;background-color: #e3e3c7  ;"" valign=""middle"" ondblclick=""OpenFile('','" & ParentID & "');""><br><h2>Aucun<h2><br></td>"))
   ...
   For Each ImageFile As String In FilesArray 
	  ...
	  NumofImag += 1
	  GalleryPlaceHolder.Controls.Add(New LiteralControl("<td width=""110px"" align=""center""  style=""height: 110px;background-color:#f1f1e3;"" valign=""middle"" ondblclick=""javascript:OpenFile('" + ImageUrl + ImageFileName + "','" & ParentID & "');"" onclick=""divClick(this,'" + ImageFileName + "');"">"))
...
'	   GalleryPlaceHolder.Controls.Add(New LiteralControl ("<br>" + ImageFileName + "<br>" + myImage.Width.ToString() + "x" + myImage.Height.ToString() + " (" + (FileLen(ImageFile)/1024).ToString("0.00") + "k)" )) 
	   ...
	   myImage.Dispose() 
                    ...
                    Catch e As Exception
                        LogMessage(HttpContext.Current.Request, "Erreur icone.aspx , " + ImageFileName + " " + e.Message)
...
If Not (FileToDelete.Value = "") AndAlso Not (FileToDelete.Value = "undefined") Then 
   ...
   Catch ex As Exception 
                ...
                LogMessage(HttpContext.Current.Request, "Erreur icone.aspx delete, " + ImagesFolder + FileToDelete.Value + " " + ex.Message)
...
function OpenFile( fileUrl , IDParent) {
	window.top.close();
	window.top.opener.focus();
	window.top.opener.SetUrl(fileUrl, IDParent);
}
</script>	
...
<%= DotNetZoom.GetLanguage("IconesFrom")%>&nbsp;
<asp:textbox id="txtMinSize" runat="server" width="30" MaxLength="3"></asp:textbox>px&nbsp
	<asp:RangeValidator id="Range"
           ...
           runat="server"/>
<%= DotNetZoom.GetLanguage("IconesTo")%>&nbsp;
<asp:textbox id="txtMaxSize" runat="server" width="30" MaxLength="3"></asp:textbox>px&nbsp
...
<div align="center">
<hr>
<span style="font-weight: bold; font-size: 8.5pt; color: black; text-decoration: none;"">
<%= DotNetZoom.GetLanguage("LabelUploadDeleteCancel")%></span>
<hr>
