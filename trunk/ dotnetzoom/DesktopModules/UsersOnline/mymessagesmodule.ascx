...
<img height="10" width="17" src="/images/1x1.gif" Alt="*" style=" background: url('/images/uostrip.gif') no-repeat; background-position: 0px -269px;" title="<%= DotNetZoom.GetLanguage("UO_Read")%>"> <%= DotNetZoom.GetLanguage("UO_Read")%>: <b><asp:label id="lblReadCount" runat="server"></asp:label></b>
