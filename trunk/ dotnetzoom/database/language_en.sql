...
begin
 ...
 Encoding = 'utf-8', 
   ...
   AdminRoleDesc = 'Site administrator', 
   UserRole = 'Member', 
   UserRoleDesc = 'Member of the site' 
 where language = 'en'
 end
GO
...
<a href="https://{DomainName}/{language}.default.aspx?edit=control&def=Signup&guid={lblGUID}" title="I accept the conditions of use">&nbsp;<b><font color="#ff0000">I accept</font></b></a>
