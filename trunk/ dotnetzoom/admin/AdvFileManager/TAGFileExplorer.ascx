        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="Name">
                ...
                <EditItemTemplate>
                    ...
                    <tag:RolloverImageButton id="imgEditOK" runat="server" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.Name") %>' CommandName="EditOK" width="16px" height="16px" DisabledImageURL="~/Admin/AdvFileManager/images/OK_Disabled.gif" EnabledImageURL="~/Admin/AdvFileManager/images/OK.gif" RolloverImageURL="~/Admin/AdvFileManager/images/OK_Rollover.gif" StatusText='<%# DotNetZoom.GetLanguage("F_Rename") %>' ToolTip='<%# DotNetZoom.GetLanguage("F_Rename") %>'></tag:RolloverImageButton>
                    <tag:RolloverImageButton id="imgEditCancel" runat="server" CommandName="EditCancel" width="16px" height="16px" DisabledImageURL="~/Admin/AdvFileManager/images/Delete_Disabled.gif" EnabledImageURL="~/Admin/AdvFileManager/images/Delete.gif" RolloverImageURL="~/Admin/AdvFileManager/images/Delete_Rollover.gif" StatusText='<%# DotNetZoom.GetLanguage("annuler") %>' ToolTip='<%# DotNetZoom.GetLanguage("annuler") %>'></tag:RolloverImageButton>
                </EditItemTemplate>
            </asp:TemplateColumn>
