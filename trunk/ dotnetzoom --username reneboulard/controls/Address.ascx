    ...
    <tbody>
        <tr id="rowCountry" runat="server">
            ...
            <td valign="top" style="white-space: nowrap;">
                ...
                <asp:Label id="lblCountryRequired" runat="server" cssclass="NormalBold"></asp:Label><label class="SubHead" style="DISPLAY: none" for="<%=chkCountry.ClientID%>"><%= DotNetZoom.getlanguage("need_country_name") %></label>
        ...
        <tr id="rowRegion" runat="server">
            ...
            <td valign="top" style="white-space: nowrap;">
                ...
                <asp:Label id="lblRegionRequired" runat="server" cssclass="NormalBold"></asp:Label><label class="SubHead" style="DISPLAY: none" for="<%=chkRegion.ClientID%>"><%= DotNetZoom.getlanguage("need_region_code") %></label>
        ...
        <tr id="rowCity" runat="server">
            ...
            <td valign="top" style="white-space: nowrap;">
                ...
                <asp:Label id="lblCityRequired" runat="server" cssclass="NormalBold"></asp:Label><label class="SubHead" style="DISPLAY: none" for="<%=chkCity.ClientID%>"><%= DotNetZoom.getlanguage("need_city_name") %></label>
        ...
        <tr id="rowStreet" runat="server">
            ...
            <td valign="top" style="white-space: nowrap;">
                ...
                <asp:Label id="lblStreetRequired" runat="server" cssclass="NormalBold"></asp:Label><label class="SubHead" style="DISPLAY: none" for="<%=chkStreet.ClientID%>"><%= DotNetZoom.getlanguage("need_street_name") %></label>
        ...
        <tr id="rowPostal" runat="server">
            ...
            <td valign="top" style="white-space: nowrap;">
                ...
                <asp:Label id="lblPostalRequired" runat="server" cssclass="NormalBold"></asp:Label><label class="SubHead" style="DISPLAY: none" for="<%=chkPostal.ClientID%>"><%= DotNetZoom.getlanguage("need_postal_code") %></label>
        ...
        <tr id="rowTelephone" runat="server">
            ...
            <td valign="top" style="white-space: nowrap;">
                ...
                <asp:Label id="lblTelephoneRequired" runat="server" cssclass="NormalBold"></asp:Label><label class="SubHead" style="DISPLAY: none" for="<%=chkTelephone.ClientID%>"><%= DotNetZoom.getlanguage("need_telephone") %></label>
